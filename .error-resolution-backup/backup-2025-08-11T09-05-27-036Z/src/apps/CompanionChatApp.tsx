...
const AgentChatList: FC<{ agents: AgentProfile[]; selectedAgentId: any | null; onSelect: (agent: AgentProfile) => void; disabled: boolean }> = ({ agents, selectedAgentId, onSelect, disabled }) => (
