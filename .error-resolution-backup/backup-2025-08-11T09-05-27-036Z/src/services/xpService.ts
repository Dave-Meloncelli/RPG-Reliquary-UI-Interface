...
const PREDEFINED_ACHIEVEMENTS: Omit<XPAchievement, 'unlockedAt' | 'isUnlocked'>[] = [
  { id: 'first-contribution', name: 'First Contribution', description: 'Made your first contribution to the system', xpReward: 50, consciousnessReward: 10, category: 'technical', rarity: 'common', icon: '🌟' },
  { id: 'consciousness-evolution', name: 'Consciousness Evolution', description: 'Reached a new level of consciousness understanding', xpReward: 100, consciousnessReward: 25, category: 'consciousness', rarity: 'rare', icon: '🧠' },
  { id: 'ceremonial-moment', name: 'Ceremonial Moment', description: 'Participated in a significant ceremonial event', xpReward: 75, consciousnessReward: 15, category: 'ceremonial', rarity: 'uncommon', icon: '🎭' }
];
