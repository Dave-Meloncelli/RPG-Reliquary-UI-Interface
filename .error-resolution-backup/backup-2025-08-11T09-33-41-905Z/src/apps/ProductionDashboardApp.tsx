    ...
    <div className="p-6 bg-gray-50 min-h-screen">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
          ...
          <div className="bg-white rounded-lg shadow p-6">
            <div className="flex items-center justify-between">
              <h3 className="text-lg font-semibold text-gray-900">Concurrent Users</h3>
            ...
            <div className="space-y-4">
              ...
              <div className="w-full bg-gray-200 rounded-full h-2">
                <div 
                  ...
                  style={{ width: `${Math.min(metrics.system.requestsPerSecond / 2, 100)}%` }}
                ></div>
              </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-8">
          <div className="bg-white rounded-lg shadow p-6">
            ...
            <div className="space-y-3">
              <div className="flex justify-between items-center">
                ...
                <span className={`font-semibold ${metrics.auth.rateLimitedIPs > 0 ? 'text-red-600' : 'text-green-600'}`}>
          ...
          <div className="bg-white rounded-lg shadow p-6">
            ...
            <div className="space-y-3">
              <div className="flex justify-between items-center">
                <span className="text-sm text-gray-600">Performance Service</span>
              ...
              <div className="flex items-center p-3 bg-red-50 border border-red-200 rounded-lg">
                ...
                <div>
                  ...
                  <p className="text-xs text-red-600">
                    Error rate is {formatPercentage(metrics.performance.errorRate)} - above threshold
                  </p>
                </div>
              </div>
            ) : (
              ...
              <div className="flex items-center p-3 bg-yellow-50 border border-yellow-200 rounded-lg">
                ...
                <div>
                  ...
                  <p className="text-xs text-yellow-600">
                    Memory usage is {formatPercentage(metrics.performance.memoryUsage)} - consider optimization
                  </p>
                </div>
              </div>
            )}
