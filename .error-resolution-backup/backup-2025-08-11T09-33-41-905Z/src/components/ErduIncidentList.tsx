...
const severityConfig: any, { color: any; icon: any
  Critical: any, icon: any,
  High: any, icon: any,
  Medium: any, icon: any,
  Low: any, icon: any;
...
const ErduIncidentList: any, onResolve, onInvestigate }) => {
                 ...
                 {isExpanded && incident.status !== 'Resolved' && (
                    <div className="mt-4 pt-4 border-t border-brand-secondary space-y-3 animate-fade-in">
                        <div>
                            ...
                            <p className="text-sm text-white italic">"Initial logs show a service degradation correlating with a spike in database latency. Agent involved: any
                        </div>
