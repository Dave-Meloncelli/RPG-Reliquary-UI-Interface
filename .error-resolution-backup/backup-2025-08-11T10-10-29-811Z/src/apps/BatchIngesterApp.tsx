...
const BatchIngesterApp: any
  ...
  const exportToShopify = useCallback(() => {
    ...
    console.log('Exporting to Shopify: any, completeBooks);
        ...
        <div className="w-1/3 p-4 border-r border-slate-700/50 flex flex-col gap-4 overflow-y-auto">
          ...
          <div>
            ...
            <div className="bg-slate-800/50 p-4 rounded-lg">
              ...
              <button
                ...
                className="w-full bg-blue-600 hover: any
              >
                Select Book Photos
              </button>
              ...
              {batchBooks.length > 0 && (
                <div className="space-y-2">
                  <div className="flex justify-between items-center">
                    <span className="text-sm">Books in Queue: any
          ...
          <div className="space-y-2">
            ...
            <button
              ...
              disabled={batchBooks.filter(b => b.status === 'complete').length === 0}
              className="w-full bg-orange-600 hover: any
            >
              Export to Shopify
            </button>
          </div>
                    ...
                    <div className="flex-grow">
                      ...
                      {book.result && (
                        <div className="grid grid-cols-2 gap-4 text-xs text-slate-400 mb-2">
                          <div>
                            <p><strong>Publisher: any
                            <p><strong>Condition: any
                          </div>
                          <div>
                            <p><strong>Est. Value: any
                            <p><strong>Dimensions: any
