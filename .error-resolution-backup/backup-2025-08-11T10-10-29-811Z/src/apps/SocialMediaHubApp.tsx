...
interface SocialPost {
  ...
  targetAudience: any[];
  contentType: 'lore' | 'community' | 'book-showcase' | 'tips' | 'news' | 'behind-scenes';
}
...
const SocialMediaHubApp: React.FC = () => {
  const [activeTab, setActiveTab] = useState<'overview' | 'content' | 'calendar' | 'analytics' | 'accounts'>('overview');
    ...
    const samplePosts: SocialPost[] = [
      {
        id: '1',
        platform: 'facebook',
        content: '🎲 Did you know that the first edition of Dungeons & Dragons was published in 1974? Today we\'re exploring the evolution of the world\'s greatest roleplaying game! What\'s your favorite D&D memory? #DnD #RPG #TabletopGaming #Community',
      ...
      },
      {
        id: '2',
        platform: 'instagram',
        content: '📚 Today\'s #BookShowcase: The Pathfinder Core Rulebook! This comprehensive guide has everything you need to start your adventure in the world of Golarion. Perfect for both new players and veterans looking to explore a rich fantasy setting. What RPG books are you reading this week? 📖✨ #Pathfinder #RPG #Fantasy #Gaming',
        image: '📚',
      ...
      },
      {
        id: '3',
        platform: 'twitter',
        content: '🤝 The RPG community is built on friendship, creativity, and shared adventures. Today we\'re celebrating the amazing people who make this hobby so special. Tag a friend who introduced you to RPGs! #RPGCommunity #Friendship #Gaming #Creativity',
  ...
  const getContentTypeColor = (type: any) => {
    switch (type) {
      case 'lore': return 'bg-purple-600';
      case 'community': return 'bg-blue-600';
      case 'book-showcase': return 'bg-green-600';
      case 'tips': return 'bg-yellow-600';
      case 'news': return 'bg-red-600';
      case 'behind-scenes': return 'bg-indigo-600';
      ...
      <div className="max-w-7xl mx-auto p-6">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-xl text-blue-200">
            Build community, share knowledge, and grow our RPG family - all while being respectful and genuine.
          </p>
        </div>
              ...
              <div className="bg-black/30 rounded-lg p-6">
                ...
                <div className="space-y-4">
                  {socialPosts.slice(0, 3).map(post => (
                    <div key={post.id} className="flex items-center gap-4 bg-black/20 p-3 rounded">
                      ...
                      <div className="text-right">
                        <p className="text-sm font-semibold text-green-400">{post.engagement.likes}</p>
              ...
              <div className="bg-black/30 rounded-lg p-6">
                ...
                <div className="space-y-4">
                  <div className="bg-black/20 p-4 rounded">
                    <h3 className="font-semibold mb-2">Community-First Approach</h3>
                    <p className="text-sm text-gray-300">Focus on building genuine connections, not just sales</p>
                  </div>
                  <div className="bg-black/20 p-4 rounded">
                    <h3 className="font-semibold mb-2">Educational Content</h3>
                    <p className="text-sm text-gray-300">Share RPG lore, tips, and behind-the-scenes insights</p>
                  </div>
                  <div className="bg-black/20 p-4 rounded">
                    <h3 className="font-semibold mb-2">Inclusive Messaging</h3>
                    <p className="text-sm text-gray-300">Welcome all players regardless of experience level</p>
                  </div>
                </div>
              </div>
            </div>
              ...
              {socialPosts.map(post => (
                <div key={post.id} className="bg-black/30 rounded-lg p-6">
                  <div className="flex items-start gap-4 mb-4">
                    ...
                    <div className="flex-grow">
                      <div className="flex items-center gap-2 mb-2">
                        ...
                        <span className={`px-2 py-1 rounded text-xs ${getContentTypeColor(post.contentType)}`}>
                          {post.contentType}
                        </span>
                      ...
                      <div className="flex flex-wrap gap-1">
                        {post.hashtags.slice(0, 3).map(tag => (
                          <span key={tag} className="text-xs bg-blue-600 px-2 py-1 rounded">#{tag}</span>
                        ))}
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="grid grid-cols-4 gap-2 text-center text-sm">
                    <div>
                      <p className="text-green-400 font-semibold">{post.engagement.likes}</p>
                      <p className="text-gray-400">Likes</p>
                    </div>
                    <div>
                      <p className="text-blue-400 font-semibold">{post.engagement.shares}</p>
                      <p className="text-gray-400">Shares</p>
                    </div>
                    <div>
                      <p className="text-purple-400 font-semibold">{post.engagement.comments}</p>
                      <p className="text-gray-400">Comments</p>
                    </div>
                    <div>
                      <p className="text-yellow-400 font-semibold">{post.engagement.clicks}</p>
          ...
          <div className="space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {accounts.map(account => (
                <div key={account.platform} className="bg-black/30 rounded-lg p-6">
                  <div className="text-center mb-4">
                    <div className="text-4xl mb-2">{getPlatformIcon(account.platform)}</div>
                  ...
                  <div className="space-y-3">
                    ...
                    <div className="flex justify-between">
                      ...
                      <span className="text-sm font-semibold">{account.engagement}%</span>
                    </div>
                    <div className="flex justify-between">
                      <span className="text-sm text-gray-400">Last Post:</span>
                      <span className="text-sm text-gray-400">{account.lastPost}</span>
                    </div>
                  </div>
              ...
              <div className="bg-black/30 rounded-lg p-6">
                ...
                <div className="space-y-4">
                  <div className="flex justify-between items-center">
                    ...
                    <span className="text-sm font-semibold text-purple-400">4.8% engagement</span>
                  </div>
                  <div className="flex justify-between items-center">
                    <span className="text-sm">Community Posts</span>
                    <span className="text-sm font-semibold text-blue-400">5.2% engagement</span>
                  </div>
                  <div className="flex justify-between items-center">
                    <span className="text-sm">Book Showcases</span>
                    <span className="text-sm font-semibold text-green-400">3.9% engagement</span>
                  </div>
                  <div className="flex justify-between items-center">
                    <span className="text-sm">Tips & Guides</span>
                    <span className="text-sm font-semibold text-yellow-400">6.1% engagement</span>
                  </div>
                </div>
              </div>
            </div>
