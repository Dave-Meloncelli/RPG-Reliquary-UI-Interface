...
export const generateText = async (
    ...
    const doRequest = async () => {
        ...
        try {
            ...
            const result = await model.generateContent(typeof contents === 'string' ? contents : JSON.stringify(contents));
...
export const analyzeRpgBookCoverWithVision = async (imageUrl: string): Promise<RpgBookAnalysis> => {
    console.warn('analyzeRpgBookCoverWithVision is stubbed - implement when needed');
