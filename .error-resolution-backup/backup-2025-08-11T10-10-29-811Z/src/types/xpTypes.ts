...
export const XP_LEVELS = [
  { level: 1, xpRequired: 0, title: 'Novice', description: 'Beginning the journey' },
  { level: 2, xpRequired: 100, title: 'Apprentice', description: 'Learning the basics' },
  { level: 3, xpRequired: 300, title: 'Adept', description: 'Developing skills' },
  { level: 4, xpRequired: 600, title: 'Expert', description: 'Mastering the craft' },
  { level: 5, xpRequired: 1000, title: 'Master', description: 'Achieving excellence' }
];
