...
var flatMorph = (o, flatMapEntry) => {
  ...
  for (const [i, entry] of Object.entries(o).entries()) {
    ...
    outputShouldBeArray || (outputShouldBeArray = typeof mapped[0] === "number");
...
var objectKindOf = (data) => {
  ...
  const name = (_a9 = prototype == null ? void 0 : prototype.constructor) == null ? void 0 : _a9.name;
...
var _clone = (input, seen) => {
  if (typeof input !== "object" || input === null)
    return input;
  if (seen == null ? void 0 : seen.has(input))
...
var Callable = class {
  constructor(fn, ...[opts]) {
    return Object.assign(Object.setPrototypeOf(fn.bind((opts == null ? void 0 : opts.bind) ?? this), this.constructor.prototype), opts == null ? void 0 : opts.attach);
  }
};
...
var fileName = () => {
  ...
  try {
    ...
    const stackLine = ((_b6 = (_a9 = error.stack) == null ? void 0 : _a9.split("\n")[2]) == null ? void 0 : _b6.trim()) || "";
    const filePath = ((_c2 = stackLine.match(/\(?(.+?)(?::\d+:\d+)?\)?$/)) == null ? void 0 : _c2[1]) || "unknown";
...
var printable = (data, opts) => {
  switch (domainOf(data)) {
    case "object":
      ...
      return ctorName === "Object" || ctorName === "Array" ? (opts == null ? void 0 : opts.quoteKeys) === false ? stringifyUnquoted(o, (opts == null ? void 0 : opts.indent) ?? 0, "") : JSON.stringify(_serialize(o, printableOpts, []), null, opts == null ? void 0 : opts.indent) : stringifyUnquoted(o, (opts == null ? void 0 : opts.indent) ?? 0, "");
    case "symbol":
  ...
  switch (domainOf(data)) {
    case "object": {
      ...
      for (const s of Object.getOwnPropertySymbols(o)) {
        result[((_a9 = opts.onSymbol) == null ? void 0 : _a9.call(opts, s)) ?? s.toString()] = _serialize(o[s], opts, nextSeen);
      }
      return result;
    }
    case "symbol":
      return printableOpts.onSymbol(data);
    case "bigint":
      return ((_b6 = opts.onBigInt) == null ? void 0 : _b6.call(opts, data)) ?? `${data}n`;
    case "undefined":
...
var hasArkKind = (value2, kind) => (value2 == null ? void 0 : value2[arkKind]) === kind;
...
var implementNode = (_) => {
  ...
  if (implementation23.hasAssociatedError) {
    (_a9 = implementation23.defaults).expected ?? (_a9.expected = (ctx) => "description" in ctx ? ctx.description : implementation23.defaults.description(ctx));
    (_b6 = implementation23.defaults).actual ?? (_b6.actual = (data) => printable(data));
    (_c2 = implementation23.defaults).problem ?? (_c2.problem = (ctx) => `must be ${ctx.expected}${ctx.actual ? ` (was ${ctx.actual})` : ""}`);
    (_d2 = implementation23.defaults).message ?? (_d2.message = (ctx) => {
...
var ToJsonSchemaError = class extends Error {
  constructor(code, context) {
    ...
    __publicField(this, "name", "ToJsonSchemaError");
...
var _a2;
(_a2 = $ark).config ?? (_a2.config = {});
var configureSchema = (config) => {
  var _a9;
  const result = Object.assign($ark.config, mergeConfigs($ark.config, config));
  (_a9 = $ark).resolvedConfig && (_a9.resolvedConfig = mergeConfigs($ark.resolvedConfig, result));
  return result;
};
...
var ArkError = class _ArkError extends (_b = CastableBase, _a3 = arkKind, _b) {
  ...
  get expected() {
    ...
    const config = ((_a9 = this.meta) == null ? void 0 : _a9.expected) ?? this.nodeConfig.expected;
  ...
  get actual() {
    ...
    const config = ((_a9 = this.meta) == null ? void 0 : _a9.actual) ?? this.nodeConfig.actual;
  ...
  get problem() {
    ...
    const config = ((_a9 = this.meta) == null ? void 0 : _a9.problem) ?? this.nodeConfig.problem;
  ...
  get message() {
    ...
    const config = ((_a9 = this.meta) == null ? void 0 : _a9.message) ?? this.nodeConfig.message;
    return typeof config === "function" ? config(this) : config;
  }
  get flat() {
...
var _a4, _b2;
var ArkErrors = class _ArkErrors extends (_b2 = ReadonlyArray, _a4 = arkKind, _b2) {
  constructor(ctx) {
    super();
    __publicField(this, _a4, "errors");
    __publicField(this, "ctx");
    /**
     * Errors by a pathString representing their location.
     */
    __publicField(this, "byPath", /* @__PURE__ */ Object.create(null));
    /**
     * All pathStrings at which errors are present mapped to the errors occuring
     * at that path or any nested path within it.
     */
    __publicField(this, "byAncestorPath", /* @__PURE__ */ Object.create(null));
...
var TraversalError = class extends Error {
  constructor(errors) {
    var __super = (...args) => {
      super(...args);
      __publicField(this, "name", "TraversalError");
      return this;
    };
    if (errors.length === 1)
...
var BaseNode = class extends Callable {
  constructor(attachments, $) {
    ...
    __publicField(this, "$");
    __publicField(this, "onFail");
    __publicField(this, "includesTransform");
    __publicField(this, "includesContextualPredicate");
    __publicField(this, "isCyclic");
    __publicField(this, "allowsRequiresContext");
    __publicField(this, "rootApplyStrategy");
    __publicField(this, "contextFreeMorph");
    __publicField(this, "rootApply");
    __publicField(this, "referencesById");
    __publicField(this, "shallowReferences");
    __publicField(this, "flatRefs");
    __publicField(this, "flatMorphs");
    __publicField(this, "allows");
    __publicField(this, "compiledMeta", compileMeta(this.metaJson));
    __publicField(this, "precedence", precedenceOfKind(this.kind));
    __publicField(this, "precompilation");
    ...
    __publicField(this, "assert", (data, pipedFromCtx) => this(data, pipedFromCtx, (errors) => errors.throw()));
    ...
    for (let i = 0; i < this.children.length; i++) {
      this.includesTransform || (this.includesTransform = this.children[i].includesTransform);
      this.includesContextualPredicate || (this.includesContextualPredicate = this.children[i].includesContextualPredicate);
      this.isCyclic || (this.isCyclic = this.children[i].isCyclic);
      if (!isStructural) {
        ...
        for (let j = 0; j < childFlatRefs.length; j++) {
          ...
          if (!this.flatRefs.some((existing) => flatRefsAreEqual(existing, childRef))) {
            ...
            for (const branch of childRef.node.branches) {
              if (branch.hasKind("morph") || branch.hasKind("intersection") && ((_a9 = branch.structure) == null ? void 0 : _a9.structuralMorph) !== void 0) {
  ...
  get description() {
    var _a9;
    return this.cacheGetter("description", ((_a9 = this.meta) == null ? void 0 : _a9.description) ?? this.$.resolvedConfig[this.kind].description(this));
  }
  ...
  _transform(mapper, ctx) {
    ...
    if (((_a9 = ctx.shouldTransform) == null ? void 0 : _a9.call(ctx, this, ctx)) === false)
      return this;
    let transformedNode;
...
var _a5, _b3;
var GenericRoot = class extends (_b3 = Callable, _a5 = arkKind, _b3) {
  constructor(paramDefs, bodyDef, $, arg$, hkt) {
    ...
    __publicField(this, "paramDefs");
    __publicField(this, "bodyDef");
    __publicField(this, "$");
    __publicField(this, "arg$");
    __publicField(this, "baseInstantiation");
    __publicField(this, "hkt");
...
var PredicateNode = class extends BaseConstraint {
  constructor() {
    ...
    __publicField(this, "compiledErrorContext", compileObjectLiteral(this.errorContext));
    __publicField(this, "traverseApply", (data, ctx) => {
...
var DivisorNode = class extends InternalPrimitiveConstraint {
  constructor() {
    ...
    __publicField(this, "impliedBasis", $ark.intrinsic.number.internal);
...
var AfterNode = class extends BaseRange {
  constructor() {
    super(...arguments);
    __publicField(this, "impliedBasis", $ark.intrinsic.Date.internal);
    __publicField(this, "collapsibleLimitString", describeCollapsibleDate(this.rule));
    __publicField(this, "traverseAllows", (data) => data >= this.rule);
  }
  reduceJsonSchema(base, ctx) {
...
var ExactLengthNode = class extends InternalPrimitiveConstraint {
  constructor() {
    ...
    __publicField(this, "impliedBasis", $ark.intrinsic.lengthBoundable.internal);
    __publicField(this, "expression", `== ${this.rule}`);
  }
  reduceJsonSchema(schema2) {
    switch (schema2.type) {
...
var PatternNode = class extends InternalPrimitiveConstraint {
  constructor() {
    ...
    __publicField(this, "compiledNegation", `!${this.compiledCondition}`);
    __publicField(this, "impliedBasis", $ark.intrinsic.string.internal);
  }
  reduceJsonSchema(base, ctx) {
    if (base.pattern) {
...
var parseNode = (ctx) => {
  ...
  const configuredSchema = ((_a9 = impl.applyConfig) == null ? void 0 : _a9.call(impl, ctx.def, ctx.$.resolvedConfig)) ?? ctx.def;
  const inner = {};
...
var BaseProp = class extends BaseConstraint {
  constructor() {
    ...
    __publicField(this, "impliedBasis", $ark.intrinsic.object.internal);
    ...
    __publicField(this, "flatRefs", append(this.value.flatRefs.map((ref) => flatRef([this.key, ...ref.path], ref.node)), flatRef([this.key], this.value)));
...
var OptionalNode = class extends BaseProp {
  constructor(...args2) {
    super(...args2);
    __publicField(this, "expression", this.hasDefault() ? `${this.compiledKey}: ${this.value.expression} = ${printable(this.inner.default)}` : `${this.compiledKey}?: ${this.value.expression}`);
    __publicField(this, "defaultValueMorph", getDefaultableMorph(this));
    __publicField(this, "defaultValueMorphRef", this.defaultValueMorph && registeredReference(this.defaultValueMorph));
...
var getDefaultableMorph = (node2) => {
  ...
  return defaultableMorphCache[cacheKey] ?? (defaultableMorphCache[cacheKey] = computeDefaultValueMorph(node2.key, node2.value, node2.default));
};
...
var BaseRoot = class extends BaseNode {
  constructor(attachments, $) {
    ...
    __publicField(this, "pipe", Object.assign(this._pipe.bind(this), {
  ...
  distribute(mapBranch, reduceMapped) {
    ...
    return (reduceMapped == null ? void 0 : reduceMapped(mappedBranches)) ?? mappedBranches;
  }
  ...
  toJsonSchema(opts = {}) {
    ...
    ctx.useRefs || (ctx.useRefs = this.isCyclic);
...
`
  ...
  hasEqualMorphs(r) {
    ...
    if (!arrayEquals(this.flatMorphs, r.flatMorphs, {
      isEqual: (l, r2) => {
        var _a9, _b6;
        return l.propString === r2.propString && (l.node.hasKind("morph") && r2.node.hasKind("morph") ? l.node.hasEqualMorphs(r2.node) : l.node.hasKind("intersection") && r2.node.hasKind("intersection") ? ((_a9 = l.node.structure) == null ? void 0 : _a9.structuralMorphRef) === ((_b6 = r2.node.structure) == null ? void 0 : _b6.structuralMorphRef) : false);
      }
    }))
      return false;
    return true;
...
var structureOf = (branch) => {
  ...
  if (branch.hasKind("intersection")) {
    return branch.inner.structure ?? (((_a9 = branch.basis) == null ? void 0 : _a9.domain) === "object" ? branch.$.bindReference($ark.intrinsic.emptyStructure) : null);
  }
...
var AliasNode = class extends BaseRoot {
  constructor() {
    super(...arguments);
    __publicField(this, "expression", this.reference);
...
var DomainNode = class extends InternalBasis {
  constructor() {
    super(...arguments);
    __publicField(this, "requiresNaNCheck", this.domain === "number" && !this.numberAllowsNaN);
    __publicField(this, "traverseAllows", this.requiresNaNCheck ? (data) => typeof data === "number" && !Number.isNaN(data) : (data) => domainOf(data) === this.domain);
    __publicField(this, "compiledCondition", this.domain === "object" ? `((typeof data === "object" && data !== null) || typeof data === "function")` : `typeof data === "${this.domain}"${this.requiresNaNCheck ? " && !Number.isNaN(data)" : ""}`);
    __publicField(this, "compiledNegation", this.domain === "object" ? `((typeof data !== "object" || data === null) && typeof data !== "function")` : `typeof data !== "${this.domain}"${this.requiresNaNCheck ? " || Number.isNaN(data)" : ""}`);
    __publicField(this, "expression", this.numberAllowsNaN ? "number | NaN" : this.domain);
  }
  get nestableExpression() {
...
var implementation14 = implementNode({
  ...
  keys: {
    ...
    structure: {
      ...
      serialize: (node2) => {
        var _a9;
        if (!((_a9 = node2.sequence) == null ? void 0 : _a9.minLength))
...
${ctx.expected}`
  ...
  intersections: {
    ...
    ...defineRightwardIntersections("intersection", (l, r, ctx) => {
      ...
      return basis instanceof Disjoint ? basis : ((_a9 = l == null ? void 0 : l.basis) == null ? void 0 : _a9.equals(basis)) ? (
...
var IntersectionNode = class extends BaseRoot {
  constructor() {
    super(...arguments);
    __publicField(this, "basis", this.inner.domain ?? this.inner.proto ?? null);
    __publicField(this, "refinements", this.children.filter((node2) => node2.isRefinement()));
    __publicField(this, "structure", this.inner.structure);
    __publicField(this, "expression", writeIntersectionExpression(this));
  ...
  get shallowMorphs() {
    var _a9;
    return ((_a9 = this.inner.structure) == null ? void 0 : _a9.structuralMorph) ? [this.inner.structure.structuralMorph] : [];
  }
  get defaultShortDescription() {
    var _a9;
    return ((_a9 = this.basis) == null ? void 0 : _a9.defaultShortDescription) ?? "present";
  }
  innerToJsonSchema(ctx) {
...
var writeIntersectionExpression = (node2) => {
  var _a9;
  let expression = ((_a9 = node2.structure) == null ? void 0 : _a9.expression) || `${node2.basis && !node2.refinements.some((n) => n.impl.obviatesBasisExpression) ? node2.basis.nestableExpression + " " : ""}${node2.refinements.map((n) => n.expression).join(" & ")}` || "unknown";
...
var implementation15 = implementNode({
  ...
  defaults: {
    description: (node2) => {
      var _a9;
      return `a morph from ${node2.in.description} to ${((_a9 = node2.out) == null ? void 0 : _a9.description) ?? "unknown"}`;
    }
  },
  intersections: {
    morph: (l, r, ctx) => {
...
var MorphNode = class extends BaseRoot {
  constructor() {
    ...
    __publicField(this, "lastMorphIfNode", hasArkKind(this.lastMorph, "root") ? this.lastMorph : void 0);
    __publicField(this, "introspectableIn", this.inner.in);
    __publicField(this, "introspectableOut", this.lastMorphIfNode ? Object.assign(this.referencesById, this.lastMorphIfNode.referencesById) && this.lastMorphIfNode.out : void 0);
    __publicField(this, "expression", `(In: ${this.in.expression}) => ${this.lastMorphIfNode ? "To" : "Out"}<${this.out.expression}>`);
    __publicField(this, "traverseAllows", (data, ctx) => !this.introspectableIn || this.introspectableIn.traverseAllows(data, ctx));
    __publicField(this, "traverseApply", (data, ctx) => {
  ...
  get shallowMorphs() {
    var _a9;
    return Array.isArray((_a9 = this.inner.in) == null ? void 0 : _a9.shallowMorphs) ? [...this.inner.in.shallowMorphs, ...this.morphs] : this.morphs;
  }
  get in() {
    var _a9;
    return this.declaredIn ?? ((_a9 = this.inner.in) == null ? void 0 : _a9.in) ?? $ark.intrinsic.unknown.internal;
  }
  get out() {
  ...
  innerToJsonSchema(ctx) {
    ...
    return ctx.fallback.morph({
      ...
      out: ((_a9 = this.introspectableOut) == null ? void 0 : _a9.toJsonSchemaRecurse(ctx)) ?? null
    });
  }
  compile(js) {
    if (js.traversalKind === "Allows") {
...
var ProtoNode = class extends InternalBasis {
  constructor() {
    super(...arguments);
    __publicField(this, "builtinName", getBuiltinNameOfConstructor(this.proto));
    __publicField(this, "serializedConstructor", this.json.proto);
    __publicField(this, "requiresInvalidDateCheck", this.proto === Date && !this.dateAllowsInvalid);
    __publicField(this, "traverseAllows", this.requiresInvalidDateCheck ? (data) => data instanceof Date && data.toString() !== "Invalid Date" : (data) => data instanceof this.proto);
    __publicField(this, "compiledCondition", `data instanceof ${this.serializedConstructor}${this.requiresInvalidDateCheck ? ` && data.toString() !== "Invalid Date"` : ""}`);
    __publicField(this, "compiledNegation", `!(${this.compiledCondition})`);
    __publicField(this, "expression", this.dateAllowsInvalid ? "Date | InvalidDate" : this.proto.name);
  ...
  innerToJsonSchema(ctx) {
    ...
    switch (this.builtinName) {
      ...
      case "Date":
        return ((_b6 = (_a9 = ctx.fallback).date) == null ? void 0 : _b6.call(_a9, { code: "date", base: {} })) ?? ctx.fallback.proto({ code: "proto", base: {}, proto: this.proto });
      default:
...
var UnionNode = class extends BaseRoot {
  constructor() {
    ...
    __publicField(this, "expression", this.distribute((n) => n.nestableExpression, expressBranches));
    ...
    __publicField(this, "traverseOptimistic", (data) => {
      for (let i = 0; i < this.branches.length; i++) {
        ...
        for (const entry of result) {
          ...
          if (!matching) {
            ...
            if (matching.cases[lSerialized]) {
              ...
              (_a9 = matching.cases)[lSerialized] ?? (_a9[lSerialized] = {
                branchIndices: [lIndex],
                condition: entry.l
              });
            }
            if (matching.cases[rSerialized]) {
              ...
              (_b6 = matching.cases)[rSerialized] ?? (_b6[rSerialized] = {
                branchIndices: [rIndex],
                condition: entry.r
              });
            }
  ...
  for (let i = 0; i < ctx.defaultEntries.length; i++) {
    ...
    if (caseCtx.branchIndices.includes(entry.originalIndex)) {
      ...
      if (pruned === null) {
        ...
        resolvedEntries == null ? void 0 : resolvedEntries.push({
      ...
      resolvedEntries == null ? void 0 : resolvedEntries.push(entry);
    else {
...
var assertDeterminateOverlap = (l, r) => {
  ...
  if (!arrayEquals(l.flatMorphs, r.flatMorphs, {
    isEqual: (l2, r2) => {
      var _a9, _b6;
      return l2.propString === r2.propString && (l2.node.hasKind("morph") && r2.node.hasKind("morph") ? l2.node.hasEqualMorphs(r2.node) : l2.node.hasKind("intersection") && r2.node.hasKind("intersection") ? ((_a9 = l2.node.structure) == null ? void 0 : _a9.structuralMorphRef) === ((_b6 = r2.node.structure) == null ? void 0 : _b6.structuralMorphRef) : false);
    }
  })) {
    throwParseError(writeIndiscriminableMorphMessage(l.expression, r.expression));
  }
...
var UnitNode = class extends InternalBasis {
  constructor() {
    ...
    __publicField(this, "traverseAllows", this.unit instanceof Date ? (data) => data instanceof Date && data.toISOString() === this.compiledValue : Number.isNaN(this.unit) ? (data) => Number.isNaN(data) : (data) => data === this.unit);
  }
  get defaultShortDescription() {
...
var IndexNode = class extends BaseConstraint {
  constructor() {
    ...
    __publicField(this, "flatRefs", append(this.value.flatRefs.map((ref) => flatRef([this.signature, ...ref.path], ref.node)), flatRef([this.signature], this.value)));
...
var implementation21 = implementNode({
  ...
  normalize: (schema2) => {
    ...
    if ("variadic" in schema2 || "prefix" in schema2 || "defaultables" in schema2 || "optionals" in schema2 || "postfix" in schema2 || "minVariadicLength" in schema2) {
      if ((_a9 = schema2.postfix) == null ? void 0 : _a9.length) {
        if (!schema2.variadic)
          return throwParseError(postfixWithoutVariadicMessage);
        if (((_b6 = schema2.optionals) == null ? void 0 : _b6.length) || ((_c2 = schema2.defaultables) == null ? void 0 : _c2.length))
  ...
  reduce: (raw, $) => {
    var _a9, _b6, _c2, _d2, _e, _f, _g;
    let minVariadicLength = raw.minVariadicLength ?? 0;
    const prefix = ((_a9 = raw.prefix) == null ? void 0 : _a9.slice()) ?? [];
    const defaultables = ((_b6 = raw.defaultables) == null ? void 0 : _b6.slice()) ?? [];
    const optionals = ((_c2 = raw.optionals) == null ? void 0 : _c2.slice()) ?? [];
    const postfix = ((_d2 = raw.postfix) == null ? void 0 : _d2.slice()) ?? [];
    if (raw.variadic) {
      while ((_e = optionals.at(-1)) == null ? void 0 : _e.equals(raw.variadic))
        optionals.pop();
      if (optionals.length === 0 && defaultables.length === 0) {
        while ((_f = prefix.at(-1)) == null ? void 0 : _f.equals(raw.variadic)) {
          prefix.pop();
          minVariadicLength++;
        }
      }
      while ((_g = postfix[0]) == null ? void 0 : _g.equals(raw.variadic)) {
        postfix.shift();
        minVariadicLength++;
      }
...
var SequenceNode = class extends BaseConstraint {
  constructor() {
    super(...arguments);
    __publicField(this, "impliedBasis", $ark.intrinsic.Array.internal);
    __publicField(this, "tuple", sequenceInnerToTuple(this.inner));
    __publicField(this, "prefixLength", ((_a6 = this.prefix) == null ? void 0 : _a6.length) ?? 0);
    __publicField(this, "defaultablesLength", ((_b4 = this.defaultables) == null ? void 0 : _b4.length) ?? 0);
    __publicField(this, "optionalsLength", ((_c = this.optionals) == null ? void 0 : _c.length) ?? 0);
    __publicField(this, "postfixLength", ((_d = this.postfix) == null ? void 0 : _d.length) ?? 0);
    __publicField(this, "defaultablesAndOptionals", []);
    __publicField(this, "prevariadic", this.tuple.filter((el) => {
    ...
    __publicField(this, "variadicOrPostfix", conflatenate(this.variadic && [this.variadic], this.postfix));
    // have to wait until prevariadic and variadicOrPostfix are set to calculate
    __publicField(this, "flatRefs", this.addFlatRefs());
    __publicField(this, "isVariadicOnly", this.prevariadic.length + this.postfixLength === 0);
    __publicField(this, "minVariadicLength", this.inner.minVariadicLength ?? 0);
    __publicField(this, "minLength", this.prefixLength + this.minVariadicLength + this.postfixLength);
    __publicField(this, "minLengthNode", this.minLength === 0 ? null : this.$.node("minLength", this.minLength));
    __publicField(this, "maxLength", this.variadic ? null : this.tuple.length);
    ...
    __publicField(this, "defaultValueMorphs", getDefaultableMorphs(this));
    __publicField(this, "defaultValueMorphsReference", this.defaultValueMorphs.length ? registeredReference(this.defaultValueMorphs) : void 0);
...
var getDefaultableMorphs = (node2) => {
  ...
  cacheKey += "]";
  return defaultableMorphsCache[cacheKey] ?? (defaultableMorphsCache[cacheKey] = morphs);
};
var Sequence = {
...
var _intersectSequences = (s) => {
  ...
  if (!lHead || !rHead)
    return s;
  const lHasPostfix = ((_a9 = lTail.at(-1)) == null ? void 0 : _a9.kind) === "postfix";
...
var createStructuralWriter = (childStringProp) => (node2) => {
  ...
  if (node2.props.length || node2.index) {
    const parts = ((_a9 = node2.index) == null ? void 0 : _a9.map((index) => index[childStringProp])) ?? [];
...
var StructureNode = class extends BaseConstraint {
  constructor() {
    ...
    __publicField(this, "props", conflatenate(this.required, this.optional));
    ...
    __publicField(this, "requiredKeys", ((_a7 = this.required) == null ? void 0 : _a7.map((node2) => node2.key)) ?? []);
    __publicField(this, "optionalKeys", ((_b5 = this.optional) == null ? void 0 : _b5.map((node2) => node2.key)) ?? []);
    __publicField(this, "literalKeys", [...this.requiredKeys, ...this.optionalKeys]);
    __publicField(this, "_keyof");
    ...
    __publicField(this, "declaresKey", (k) => {
      var _a9;
      return k in this.propsByKey || ((_a9 = this.index) == null ? void 0 : _a9.some((n) => n.signature.allows(k))) || this.sequence !== void 0 && $ark.intrinsic.nonNegativeIntegerString.allows(k);
    });
    __publicField(this, "structuralMorphRef", this.structuralMorph && registeredReference(this.structuralMorph));
  }
  keyof() {
    if (this._keyof)
      return this._keyof;
  ...
  map(flatMapProp) {
    return this.$.node("structure", this.props.flatMap(flatMapProp).reduce((structureInner, mapped) => {
      ...
      const mappedKind = mapped.kind ?? (originalProp == null ? void 0 : originalProp.kind) ?? "required";
    ...
    if (this.index) {
      for (const n of this.index) {
        if (typeOrTermExtends(key, n.signature))
          value2 = (value2 == null ? void 0 : value2.and(n.value)) ?? n.value;
      }
    }
    if (this.sequence && typeOrTermExtends(key, $ark.intrinsic.nonNegativeIntegerString)) {
      if (hasArkKind(key, "root")) {
        if (this.sequence.variadic)
          value2 = (value2 == null ? void 0 : value2.and(this.sequence.element)) ?? this.sequence.element;
      } else {
        const index = Number.parseInt(key);
        if (index < this.sequence.prevariadic.length) {
          const fixedElement = this.sequence.prevariadic[index].node;
          value2 = (value2 == null ? void 0 : value2.and(fixedElement)) ?? fixedElement;
          required || (required = index < this.sequence.prefixLength);
        } else if (this.sequence.variadic) {
          const nonFixedElement = this.$.node("union", this.sequence.variadicOrPostfix);
          value2 = (value2 == null ? void 0 : value2.and(nonFixedElement)) ?? nonFixedElement;
        }
      }
    }
    if (!value2) {
      if (((_a9 = this.sequence) == null ? void 0 : _a9.variadic) && hasArkKind(key, "root") && key.extends($ark.intrinsic.number)) {
  ...
  get defaultable() {
    var _a9;
    return this.cacheGetter("defaultable", ((_a9 = this.optional) == null ? void 0 : _a9.filter((o) => o.hasDefault())) ?? []);
  }
  ...
  reduceJsonSchema(schema2, ctx) {
    ...
    switch (schema2.type) {
      ...
      case "array":
        const arraySchema = ((_a9 = this.sequence) == null ? void 0 : _a9.reduceJsonSchema(schema2, ctx)) ?? schema2;
      ...
      for (const index of this.index) {
        ...
        for (const keyBranch of index.signature.branches) {
          ...
          if (pattern) {
            ...
            schema2.patternProperties ?? (schema2.patternProperties = {});
...
var constructStructuralMorphCacheKey = (node2) => {
  ...
  if ((_a9 = node2.sequence) == null ? void 0 : _a9.defaultValueMorphsReference)
    cacheKey += (_b6 = node2.sequence) == null ? void 0 : _b6.defaultValueMorphsReference;
...
var getPossibleMorph = (node2) => {
  ...
  const $arkStructuralMorph = (data, ctx) => {
    ...
    if ((_a9 = node2.sequence) == null ? void 0 : _a9.defaultables) {
...
var precompileMorphs = (js, node2) => {
  var _a9;
  const requiresContext = node2.defaultable.some((node3) => node3.defaultValueMorph.length === 2) || ((_a9 = node2.sequence) == null ? void 0 : _a9.defaultValueMorphs.some((morph) => morph.length === 2));
  ...
  return js.block(`${args2} => `, (js2) => {
    ...
    if ((_a10 = node2.sequence) == null ? void 0 : _a10.defaultables) {
...
var BaseScope = class {
  constructor(def, config) {
    ...
    __publicField(this, "nodesByHash", {});
    __publicField(this, "intrinsic");
    ...
    __publicField(this, "schema", (schema2, opts) => this.finalize(this.parseSchema(schema2, opts)));
    __publicField(this, "parseSchema", (schema2, opts) => this.node(schemaKindOf(schema2), schema2, opts));
    __publicField(this, "precompilation");
    ...
    __publicField(this, "parse", (def, opts = {}) => this.finalize(this.parseDefinition(def, opts)));
    ...
    rawUnknownUnion ?? (rawUnknownUnion = this.node("union", {
      branches: [
        "string",
        "number",
        "object",
  ...
  preparseNode(kinds, schema2, opts) {
    ...
    if (isNode(schema2) && schema2.kind === kind)
      return schema2;
    const impl = nodeImplementationsByKind[kind];
    const normalizedSchema = ((_a9 = impl.normalize) == null ? void 0 : _a9.call(impl, schema2, this)) ?? schema2;
  ...
  maybeResolve(name) {
    ...
    let def = this.aliases[name] ?? ((_a9 = this.ambient) == null ? void 0 : _a9[name]);
    if (!def)
...
var maybeParseReference = (s, token) => {
  var _a9;
  if ((_a9 = s.ctx.args) == null ? void 0 : _a9[token]) {
...
var _ArkTypeScanner = class _ArkTypeScanner extends Scanner {
  shiftUntilNextTerminator() {
    this.shiftUntilNonWhitespace();
    return this.shiftUntil(() => this.lookahead in _ArkTypeScanner.terminatingChars);
  }
};
__publicField(_ArkTypeScanner, "terminatingChars", {
  "<": 1,
  ">": 1,
  "=": 1,
  "|": 1,
...
__publicField(_ArkTypeScanner, "finalizingLookaheads", {
  ">": 1,
  ",": 1,
  "": 1,
  "=": 1,
...
__publicField(_ArkTypeScanner, "lookaheadIsFinalizing", (lookahead, unscanned) => lookahead === ">" ? unscanned[0] === "=" ? (
...
var ArkTypeScanner = _ArkTypeScanner;
...
var DynamicState = class _DynamicState {
  ...
  pushRootToBranch(token) {
    ...
    this.root = void 0;
    this.branches.intersection = ((_a9 = this.branches.intersection) == null ? void 0 : _a9.rawAnd(root)) ?? root;
    if (token === "&")
      return;
    this.branches.union = ((_b6 = this.branches.union) == null ? void 0 : _b6.rawOr(this.branches.intersection)) ?? this.branches.intersection;
    this.branches.intersection = null;
    if (token === "|")
      return;
    this.branches.pipe = ((_c2 = this.branches.pipe) == null ? void 0 : _c2.rawPipeOnce(this.branches.union)) ?? this.branches.union;
  ...
  previousOperator() {
    var _a9;
    return ((_a9 = this.branches.leftBound) == null ? void 0 : _a9.comparator) ?? this.branches.prefixes.at(-1) ?? (this.branches.intersection ? "&" : this.branches.union ? "|" : this.branches.pipe ? "|>" : void 0);
  }
  shiftedByOne() {
    this.scanner.shift();
    return this;
...
var parseObjectLiteral = (def, ctx) => {
  ...
  for (const [k, v] of defEntries) {
    ...
    if (parsedKey.kind === "spread") {
      ...
      !((_a9 = operand.basis) == null ? void 0 : _a9.equals(intrinsic.object))) {
...
var parseInnerDefinition = (def, ctx) => {
  ...
  if (typeof def === "string") {
    ...
    const scopeCache = parseCache[_a9 = ctx.$.name] ?? (parseCache[_a9] = {});
    return scopeCache[def] ?? (scopeCache[def] = parseString(def, ctx));
  }
...
var _InternalScope = class _InternalScope extends BaseScope {
  constructor() {
    super(...arguments);
    __publicField(this, "unit", (value2) => this.units([value2]));
    __publicField(this, "valueOf", (tsEnum) => this.units(enumValues(tsEnum)));
    __publicField(this, "enumerated", (...values) => this.units(values));
    __publicField(this, "instanceOf", (ctor) => this.node("proto", { proto: ctor }, { prereduced: true }));
    __publicField(this, "or", (...defs) => this.schema(defs.map((def) => this.parse(def))));
    __publicField(this, "and", (...defs) => defs.reduce((node2, def) => node2.and(this.parse(def)), this.intrinsic.unknown));
    __publicField(this, "merge", (...defs) => defs.reduce((node2, def) => node2.merge(this.parse(def)), this.intrinsic.object));
    __publicField(this, "pipe", (...morphs) => this.intrinsic.unknown.pipe(...morphs));
    __publicField(this, "match", new InternalMatchParser(this));
    __publicField(this, "declare", () => ({
      type: this.type
    }));
    __publicField(this, "type", new InternalTypeParser(this));
  }
  ...
  preparseOwnAliasEntry(alias, def) {
    ...
    if (firstParamIndex === -1) {
      ...
      const config = (_a9 = this.resolvedConfig.keywords) == null ? void 0 : _a9[qualifiedName];
      if (config)
        def = [def, "@", config];
      return [alias, def];
    }
...
__publicField(_InternalScope, "scope", (def, config = {}) => new _InternalScope(def, config));
__publicField(_InternalScope, "module", (def, config = {}) => _InternalScope.scope(def, config).export());
...
var MergeHkt = class extends Hkt {
  constructor() {
    super(...arguments);
    __publicField(this, "description", 'merge an object\'s properties onto another like `Merge(User, { isAdmin: "true" })`');
  }
};
...
var RecordHkt = class extends Hkt {
  constructor() {
    super(...arguments);
    __publicField(this, "description", 'instantiate an object from an index signature and corresponding value type like `Record("string", "number")`');
  }
};
...
var PickHkt = class extends Hkt {
  constructor() {
    super(...arguments);
    __publicField(this, "description", 'pick a set of properties from an object like `Pick(User, "name | age")`');
  }
};
...
var OmitHkt = class extends Hkt {
  constructor() {
    super(...arguments);
    __publicField(this, "description", 'omit a set of properties from an object like `Omit(User, "age")`');
  }
};
...
var PartialHkt = class extends Hkt {
  constructor() {
    super(...arguments);
    __publicField(this, "description", "make all named properties of an object optional like `Partial(User)`");
  }
};
...
var RequiredHkt = class extends Hkt {
  constructor() {
    super(...arguments);
    __publicField(this, "description", "make all named properties of an object required like `Required(User)`");
  }
};
...
var ExcludeHkt = class extends Hkt {
  constructor() {
    super(...arguments);
    __publicField(this, "description", 'exclude branches of a union like `Exclude("boolean", "true")`');
  }
};
...
var ExtractHkt = class extends Hkt {
  constructor() {
    super(...arguments);
    __publicField(this, "description", 'extract branches of a union like `Extract("0 | false | 1", "number")`');
  }
};
