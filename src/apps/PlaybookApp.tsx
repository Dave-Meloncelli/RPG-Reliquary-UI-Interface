    ...
    setPlaybooks([
      {
        ...
        description: "Multi-agent analysis of consciousness-related topics",
        steps: [
          {
            name: "Initial Assessment",
            prompt: "Analyze the consciousness implications of the given topic",
            agentId: "consciousness-agent",
          },
          {
            name: "Ethical Review",
            prompt: "Review ethical considerations and dignity implications",
    ...
    <div className="flex flex-col h-full bg-slate-900/80 text-slate-200 font-sans">
      <div className="p-4 border-b border-slate-700/50">
        ...
        <p className="text-sm text-slate-400">
          A library of pre-defined multi-agent workflows (Operation Chains).
        </p>
      </div>
