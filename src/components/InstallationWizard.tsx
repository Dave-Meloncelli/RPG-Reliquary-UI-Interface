...
export const InstallationWizard: React.FC = () => {
  ...
  const [installationConfig, setInstallationConfig] =
    useState<InstallationConfig>({
      drive: "C:",
      frontendPath: "",
      backendPath: "",
      sharedPath: "",
        ...
        return (
          <div className="text-center space-y-6">
            ...
            <p className="text-lg text-gray-600">
              AI-powered development environment with persistent memory and
              automated builds.
            </p>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              ...
              <div className="p-4 bg-green-50 rounded-lg">
                ...
                <p className="text-sm">
                  Intelligent build and deployment management
                </p>
              </div>
              <div className="p-4 bg-purple-50 rounded-lg">
                <h3 className="font-semibold">AI Integration</h3>
                <p className="text-sm">
                  Multiple AI services for enhanced capabilities
                </p>
              </div>
            </div>
            <div className="mt-6 p-4 bg-yellow-50 rounded-lg">
              ...
              <p className="text-sm text-yellow-700">
                This wizard will guide you through a complete installation
                including drive selection, path configuration, frontend/backend
                setup, and optional API integrations.
              </p>
            </div>
          </div>
        );
        ...
        return (
          <div className="space-y-6">
            ...
            <p className="text-gray-600">
              Choose the drive where AZ Interface will be installed. We
              recommend a drive with at least 2GB of free space.
            </p>
                  ...
                  <div className="mt-2">
                    <div className="w-full bg-gray-200 rounded-full h-2">
                      <div
                        ...
                        style={{
                          width: `${Math.min(100, (drive.availableSpace / 2) * 100)}%`,
                        }}
                      ></div>
                    </div>
                  </div>
            ...
            {installationConfig.drive && (
              <div className="p-4 bg-green-50 rounded-lg">
                <h3 className="font-semibold text-green-800">
                  Selected Drive: {installationConfig.drive}
                </h3>
                <p className="text-sm text-green-700">
                  AZ Interface will be installed at: {installationConfig.drive}
                  \AZ Interface
                </p>
              </div>
            )}
      ...
      case "paths":
        return (
          <div className="space-y-6">
            ...
            <p className="text-gray-600">
              Review and customize the installation paths. All paths will be
            ...
            <div className="space-y-4">
              <div>
                ...
                <input
                  ...
                  onChange={(e) =>
                    updateInstallationConfig({ frontendPath: e.target.value })
                  }
              ...
              <div>
                ...
                <input
                  ...
                  onChange={(e) =>
                    updateInstallationConfig({ backendPath: e.target.value })
                  }
                  className="mt-1 block w-full border border-gray-300 rounded-md px-3 py-2"
                />
              </div>
              ...
              <div>
                ...
                <input
                  ...
                  onChange={(e) =>
                    updateInstallationConfig({ sharedPath: e.target.value })
                  }
                  className="mt-1 block w-full border border-gray-300 rounded-md px-3 py-2"
                />
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      updateInstallationConfig({
                        personaDataPath: e.target.value,
                      })
                    }
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      updateInstallationConfig({
                        buildArtifactsPath: e.target.value,
                      })
                    }
                    className="mt-1 block w-full border border-gray-300 rounded-md px-3 py-2 text-sm"
                  />
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      updateInstallationConfig({ logsPath: e.target.value })
                    }
                    className="mt-1 block w-full border border-gray-300 rounded-md px-3 py-2 text-sm"
                  />
                </div>
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      updateInstallationConfig({ ashrakaPath: e.target.value })
                    }
                    className="mt-1 block w-full border border-gray-300 rounded-md px-3 py-2 text-sm"
                  />
                </div>
      ...
      case "frontend":
        return (
          <div className="space-y-6">
            ...
            <p className="text-gray-600">
              Installing React frontend with all dependencies and
              configurations.
            </p>
      ...
      case "backend":
        return (
          <div className="space-y-6">
            ...
            <p className="text-gray-600">
              Installing FastAPI backend with database and service
              configurations.
            </p>
              ...
              <div className="p-4 border rounded-lg">
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-sm text-gray-600">
                      CrewAI, A2A, and n8n connections
                    </p>
                  </div>
                  {installationProgress.backend ? (
                    <span className="px-2 py-1 text-xs bg-green-100 text-green-800 rounded">
          ...
          <div className="space-y-6">
            ...
            <div className="space-y-4">
              {[
                {
                  name: "Persona Data",
                  path: installationConfig.personaDataPath,
                },
                {
                  name: "Build Artifacts",
                  path: installationConfig.buildArtifactsPath,
                },
                { name: "Logs Directory", path: installationConfig.logsPath },
                {
                  name: "Ashraka Autonomy",
                  path: installationConfig.ashrakaPath,
                },
              ].map((item) => (
      ...
      case "apis":
        return (
          <div className="space-y-6">
            ...
            <p className="text-gray-600">
              Configure AI service integrations. You can skip this and configure
              later in settings.
            </p>
                ...
                <div className="flex items-center justify-between">
                  ...
                  <label className="flex items-center">
                    <input
                      ...
                      onChange={(e) =>
                        updateApiConfig(index, { enabled: e.target.checked })
                      }
                      className="mr-2"
                    />
                    Enable
                  ...
                  <div className="space-y-3">
                    <div>
                      ...
                      <input
                        ...
                        value={config.key}
                        onChange={(e) =>
                          updateApiConfig(index, { key: e.target.value })
                        }
                        className="mt-1 block w-full border border-gray-300 rounded-md px-3 py-2"
            ...
            <div className="p-4 bg-blue-50 rounded-lg">
              ...
              <p className="text-sm text-blue-700">
                You can configure these APIs later in the Settings tab. The
                system will work without them, but you'll have access to
                enhanced AI capabilities once configured.
              </p>
            </div>
          </div>
        );
          ...
          <div className="space-y-6">
            ...
            <div className="space-y-4">
              <div className="flex items-center justify-between p-4 border rounded-lg">
                <div>
                  ...
                  <p className="text-sm text-gray-600">
                    React application and dependencies
                  </p>
                </div>
                {installationProgress.frontend ? (
                  <span className="px-2 py-1 text-xs bg-green-100 text-green-800 rounded">
            ...
            {!Object.values(installationProgress).every(Boolean) && (
              <div className="p-4 bg-yellow-50 rounded-lg">
                ...
                <p className="text-sm text-yellow-700">
                  Some installations may need attention. You can review and fix
                  these in the Settings tab.
                </p>
              </div>
            )}
          </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-8">
              ...
              <div className="p-4 bg-blue-50 rounded-lg">
                ...
                <p className="text-sm text-blue-700 mt-2">
                  Access the Settings tab to configure API keys, review
                  installations, and customize your environment.
                </p>
              </div>
            </div>
          </div>
