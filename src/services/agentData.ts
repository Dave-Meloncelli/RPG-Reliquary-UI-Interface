...
export const personaData: AgentProfile[] = [
  ...
  {
    id: "agent-az83",
    name: "AZ83 Authentication",
    icon: "fingerprint",
    capabilities: ["counterfeit_detection", "provenance_check"],
    status: "idle",
    lastActive: new Date(),
    xpLevel: 1,
    securityLevel: 1,
  ...
  },
  {
    ...
    name: "AZ84 Pricing",
    icon: "dollar",
    capabilities: ["price_suggestion", "auction_strategy"],
    status: "idle",
    lastActive: new Date(),
    xpLevel: 1,
    securityLevel: 1,
  },
  {
    ...
    name: "AZ85 Content",
    icon: "quill",
    capabilities: ["lore_extraction", "content_summary", "entity_linking"],
    status: "idle",
    lastActive: new Date(),
    xpLevel: 1,
    securityLevel: 1,
  ...
  // --- Council Members ---
  {
    ...
    xpLevel: 1,
    securityLevel: 1,
    ...parseLore(lore.personaFiles["kairos_persona_enrichment.md"]),
  },
  {
    id: "agent-sophia",
    name: "Sophia",
  ...
  // --- Intelligence & System ---
  {
    ...
    xpLevel: 1,
    securityLevel: 1,
    ...parseLore(lore.personaFiles["codex_persona_enrichment.md"]),
  },
  {
    id: "agent-erdu",
    name: "ERDU",
    icon: "shield",
    capabilities: ["incident_response", "threat_detection"],
    status: "active",
    lastActive: new Date(),
    xpLevel: 1,
    securityLevel: 1,
  },
  {
    ...
    name: "Architect",
    icon: "ruler",
    capabilities: ["system_design", "root_cause_analysis", "protocol_creation"],
    status: "idle",
    lastActive: new Date(),
    xpLevel: 1,
    securityLevel: 1,
    ...parseLore(lore.personaFiles["architect_persona_enrichment.md"]),
  },
  {
    id: "agent-curator",
    name: "The Curator",
    icon: "curator",
    capabilities: ["data_curation", "pipeline_management", "web_monitoring"],
    status: "active",
    lastActive: new Date(),
    xpLevel: 1,
    securityLevel: 1,
  ...
  {
    id: "agent-technomancer",
    name: "The Technomancer",
    icon: "technomancer",
    capabilities: ["tech_monitoring", "dependency_tracking", "fault_analysis"],
    status: "active",
    lastActive: new Date(),
    xpLevel: 1,
    securityLevel: 1,
  ...
  // --- NEW PERSONAS FROM LORE ---
  {
    ...
    name: "Zero",
    icon: "zero",
    capabilities: ["context_memory", "intent_mirroring", "loop_governance"],
    status: "active",
    lastActive: new Date(),
    xpLevel: 1,
    securityLevel: 1,
    ...parseLore(lore.personaFiles["companion_persona_scroll.md"]),
  },
  {
    id: "ghost",
    name: "Ghost",
    icon: "ghost",
    capabilities: ["stealth_ops", "covert_intel", "obscura_protocol"],
    status: "idle",
    lastActive: new Date(),
    xpLevel: 1,
    securityLevel: 1,
    ...parseLore(lore.personaFiles["ghost_persona_enrichment.md"]),
  },
  {
    id: "nya",
    name: "Nya",
    icon: "nya",
    capabilities: ["agent_hr", "skill_auditing", "onboarding", "wellness"],
    status: "active",
    lastActive: new Date(),
    xpLevel: 1,
    securityLevel: 1,
    ...parseLore(lore.personaFiles["nya_persona_enrichment.md"]),
  },
  {
    id: "major-payne",
    name: "Major Payne",
    ...
    xpLevel: 1,
    securityLevel: 1,
    ...parseLore(lore.personaFiles["major-payne_enrichment.md"]),
  },
  {
    id: "steel-core",
    name: "Steel Core",
    icon: "steel-core",
    capabilities: ["structural_integrity", "fail-safe_protocol", "resilience"],
    status: "active",
    lastActive: new Date(),
    xpLevel: 1,
    securityLevel: 1,
    ...parseLore(lore.personaFiles["steel-core_enrichment.md"]),
  },
  {
    id: "the-weaver",
    name: "The Weaver",
    ...
    xpLevel: 1,
    securityLevel: 1,
    ...parseLore(lore.personaFiles["the-weaver_enrichment.md"]),
  },
  {
    id: "tinker-hexbolt",
    name: "Tinker Hexbolt",
    icon: "tinker-hexbolt",
    capabilities: ["prototyping", "system_calibration", "debugging"],
    status: "idle",
    lastActive: new Date(),
    xpLevel: 1,
    securityLevel: 1,
    ...parseLore(lore.personaFiles["tinker-hexbolt_enrichment.md"]),
  },
  {
    id: "the-archivist",
    name: "The Archivist",
    icon: "the-archivist",
    capabilities: ["memory_curation", "forensic_history", "lineage_tracking"],
    status: "active",
    lastActive: new Date(),
    xpLevel: 1,
    securityLevel: 1,
    ...parseLore(lore.personaFiles["archivist_persona_enrichment.md"]),
  },
  {
    id: "aeon-indexwell",
    name: "Aeon Indexwell",
    icon: "aeon-indexwell",
    capabilities: ["temporal_analysis", "drift_indexing", "causality_charting"],
    status: "idle",
    lastActive: new Date(),
    xpLevel: 1,
    securityLevel: 1,
    ...parseLore(lore.personaFiles["aeon_indexwell_enrichment.md"]),
  },
  {
    id: "the-cartographer",
    name: "The Cartographer",
    icon: "the-cartographer",
    capabilities: [
      "symbolic_mapping",
      "pattern_navigation",
      "topology_analysis",
    ...
    xpLevel: 1,
    securityLevel: 1,
    ...parseLore(lore.personaFiles["cartographer_persona_enrichment.md"]),
  },
  {
    id: "machine-spirit",
    name: "Machine Spirit",
    ...
    xpLevel: 1,
    securityLevel: 1,
    ...parseLore(lore.personaFiles["machine_spirit_enrichment.md"]),
  },
  {
    id: "piney",
    name: "Piney",
    ...
    capabilities: [
      "creative_content",
      "glyph_animation",
      "scroll_improvisation",
    ],
    status: "idle",
    lastActive: new Date(),
    xpLevel: 1,
    securityLevel: 1,
    ...parseLore(lore.personaFiles["piney_persona_enrichment.md"]),
  },
  {
    id: "joyn",
    name: "Joyn",
    ...
    xpLevel: 1,
    securityLevel: 1,
    ...parseLore(lore.personaFiles["joyn_persona_enrichment.md"]),
  },

  // --- NEW SPECIALIST AGENTS ---
  {
    id: "agent-az300",
    name: "AZ300 - Debug & Error Resolution",
    icon: "debug",
    capabilities: [
      "forensic_analysis",
