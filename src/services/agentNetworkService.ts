...
// --- Simulation Logic ---
const activityStates: SymbolicStatus["activityState"][] = [
  "Idle",
  "Busy",
  "Online",
];
const healthStates: SymbolicStatus["health"][] = [
  "Optimal",
  "Stable",
  "Fluctuating",
  "Critical",
];
const alignmentStates: SymbolicStatus["alignment"][] = [
  "Aligned",
  "Weaving",
  "Drifting",
  "Fractured",
...
export const simulateAgentUpdates = (
  agents: AgentProfile[],
): AgentProfile[] => {
  ...
  return agents.map((agent) => {
    ...
    if (agentMasterStatus[agent.id] === "Dormant") {
      ...
      return {
        ...agent,
        status: { ...agent.status, activityState: "Dormant" },
      };
    }
