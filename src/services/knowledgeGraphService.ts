...
const MOCK_EVENTS: Omit<ForensicEvent, "id">[] = [
  {
    ...
    type: "commit",
    author: "kairos-dev",
    summary: "feat: Add rate limiting middleware",
  },
  {
    componentId: "api-gateway",
    timestamp: "2024-05-18 11:30:00",
    type: "deploy",
    author: "system-ci",
    summary: "Deployment to staging successful",
  },
  {
    ...
    type: "config_change",
    author: "operator",
    summary: "Increased OpenAI provider timeout to 90s",
  },
  {
    componentId: "api-gateway",
    timestamp: "2024-05-19 14:22:00",
    type: "error",
    author: "system-log",
    summary: "504 Gateway Timeout from upstream service",
  },
  {
    componentId: "orchestrator",
    ...
    type: "log",
    author: "system-log",
    summary: "Fallback triggered: OpenAI -> Chutes.ai",
  },
  {
    componentId: "api-gateway",
    timestamp: "2024-05-20 16:00:00",
    type: "commit",
    author: "jordan-refactor",
    summary: "fix: Handle upstream timeouts gracefully",
  },
  {
    componentId: "api-gateway",
    timestamp: "2024-05-20 17:30:00",
    type: "deploy",
    author: "system-ci",
    summary: "Hotfix deployment to production successful",
  },
];
...
const MOCK_LINEAGE: Record<string, Omit<CodeLineage, "id">> = {
  "agent-az300": {
    ...
    description:
      "A specialist agent for performing deep forensic analysis on system failures.",
    dependencies: ["knowledgeGraphService", "ERDU Monitor"],
    relatedDocuments: [
      "Deep Research - FTC LNSU-1.txt",
      "system_analysis_recursive.md",
    ],
    commitHistory: [
      {
        id: "c0a9b1c",
        summary: "feat: Initial scaffolding for AZ300 agent",
        author: "wingman",
        date: "2024-05-21",
      },
      {
        id: "d1b2c3d",
        summary: "feat: Integrate with knowledge graph for timeline analysis",
        author: "wingman",
        date: "2024-05-22",
      },
      {
        id: "e2c3d4e",
        summary: "refactor: Optimize timeline rendering performance",
        author: "wingman",
        date: "2024-05-23",
      },
    ],
  ...
  "agent-az400": {
    ...
    description:
      "A specialist agent for tracing the history, dependencies, and evolution of system components.",
    dependencies: [
    ...
    relatedDocuments: [
      "AZ400 - Code Archaeologist & Feature Discovery Agent.pdf",
    ],
    commitHistory: [
      {
        id: "f3d4e5f",
        summary: "feat: Initial scaffolding for AZ400 agent",
        author: "wingman",
        date: "2024-05-21",
      },
      {
        id: "g4e5f6g",
        summary: "feat: Add dependency and documentation linking",
        author: "wingman",
        date: "2024-05-22",
      },
    ],
...
class KnowledgeGraphService {
   ...
   */
  public async getCodeLineage(
    featureName: string,
  ): Promise<CodeLineage | null> {
    await delay(1000 + Math.random() * 800);

    const foundKey = Object.keys(MOCK_LINEAGE).find(
      (key) =>
