...
class N8nService {
  ...
  constructor() {
    this.state = {
      workflows: [
        {
          id: "wf-publish-product",
          name: "Publish Product to Shopify",
          description:
            "Full pipeline for taking an analyzed product and creating a live Shopify listing.",
          status: "Idle",
        },
        {
          id: "wf-social-media",
          ...
          description:
            "Takes product info and generates posts for various social platforms.",
          status: "Idle",
        },
        {
          id: "wf-create-placeholders",
          name: "Create Shopify Placeholders",
          description:
            "Creates draft product listings in Shopify from curated book data.",
          status: "Idle",
        },
      ],
      runHistory: {},
    ...
    setTimeout(
      () => {
        ...
        run.output = success
          ? {
              success: true,
              data: { message: `Workflow ${workflowId} completed.` },
            }
          : { success: false, error: "A simulated error occurred." };
